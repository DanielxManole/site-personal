    ...
    <div className="fixed bottom-8 left-8 z-[9999]">
      ...
      >
        ...
        <div className={`
            ...
            ${isExpanded
                ? `bg-[#e0e5ec]/90 backdrop-blur-md ${interactionReady ? 'group-hover:bg-slate-200/90' : ''}` 
                : `bg-slate-200 ${interactionReady ? 'group-hover:bg-[#e0e5ec]/90' : ''}`
            }

            ${isExpanded 
                ? `w-full origin-left ${interactionReady ? 'group-hover:w-[215px]' : ''}` 
                : 'w-full'
            }
        `}>
