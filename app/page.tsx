      ...
      <div className="relative flex flex-col items-center justify-center min-h-screen w-full py-20 **overflow-hidden**">
        ...
        <div ref={heroRef} className="z-10 bg-[#e0e5ec] p-7 md:p-16 rounded-3xl shadow-[20px_20px_60px_#bec3c9,-20px_-20px_60px_rgba(255,255,255,0.5)] max-w-4xl w-full text-center border border-white/40 relative mx-4 mt-10">
          ...
          <div className="absolute -left-4 md:-left-12 top-0 bottom-0 w-px bg-slate-400 flex flex-col justify-center items-center opacity-60 select-none">
              <span className="bg-[#e0e5ec] py-2 text-[10px] font-mono font-bold -rotate-90 text-slate-500">HEIGHT: {dimensions.height}px</span>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6 select-none">
            ...
            <div className="relative group/btn">
              <a href="#proiecte" className="flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-[#e0e5ec] text-blue-600 font-bold shadow-[6px_6px_12px_#bec3c9,-6px_-6px_12px_rgba(255,255,255,0.5)] transition-all duration-300 ease-out group-hover/btn:shadow-[inset_6px_6px_12px_#bec3c9,inset_-6px_-6px_12px_rgba(255,255,255,0.5)] group-hover/btn:scale-95">
                Proiecte
            ...
            {/* BUTON: Contact */}
            <div className="relative group/btn">
              <a href="#contact" className="flex items-center justify-center gap-3 px-8 py-4 rounded-xl bg-blue-600 text-white font-bold shadow-[6px_6px_12px_#a1a6ac,-6px_-6px_12px_rgba(255,255,255,0.5)] transition-all duration-300 ease-out group-hover/btn:bg-blue-700 group-hover/btn:-translate-y-1">
                Contact
