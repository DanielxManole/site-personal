...
export default function TechStack() {
  ...
  // Render skill-uri ca butoane, păstrând exact design-ul original
  const renderSkills = (
    skills: string[],
    activeBg: string,
    activeText: string,
    ...
    return skills.map((item) => (
      <button
        ...
        className={`
          touch-manipulation
          px-3 py-1 text-sm font-mono font-bold border border-slate-600 cursor-pointer
          transition-colors ease-out
          ${isActive(item) ? "duration-75" : "duration-300"}
          ${isActive(item)
            ? `${activeBg} ${activeText}`
            : `text-slate-700 bg-transparent hover:${hoverBg} hover:${hoverText}`
          }
          active:scale-[0.95]
        `}
      >
    ...
    >
      ...
      >
        <div className="mb-16 flex flex-col md:flex-row md:items-end gap-4 border-b-2 border-slate-800 pb-4 transform-gpu">
          ...
          <span className="font-mono text-blue-600 mb-2 text-sm font-bold select-none">// TECHNICAL_SKILLS</span>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="relative p-8 border-2 border-slate-400 bg-[#f5f7fa] h-full shadow-[6px_6px_12px_#bec3c9,-6px_-6px_12px_rgba(255,255,255,0.5)] transform-gpu">
            ...
            <div className="space-y-8">
              <div>
                <p className="font-mono text-[14px] font-bold text-slate-500 mb-1 uppercase tracking-widest">Scripting & AI</p>
                <div className="flex flex-wrap gap-3 select-none">
                  {renderSkills(
                    ["Python", "Tkinter", "C / C++", "PyTorch", "OpenCV"],
                    "bg-slate-800",
                    "text-white",
                    "bg-slate-800",
                    "text-white"
              ...
              <div>
                <p className="font-mono text-[14px] font-bold text-slate-500 mb-1 uppercase tracking-widest">Web & Cloud</p>
                <div className="flex flex-wrap gap-3 select-none">
                  {renderSkills(
                    ["Next.js", "React", "TypeScript", "Tailwind CSS", "Framer Motion", "Git / Github", "Vercel"],
                    "bg-slate-800",
                    "text-white",
                    "bg-slate-800",
                    "text-white"
          ...
          <div className="relative p-8 border-2 border-slate-400 bg-[#f5f7fa] h-full shadow-[6px_6px_12px_#bec3c9,-6px_-6px_12px_rgba(255,255,255,0.5)] transform-gpu">
            ...
            <div className="space-y-8">
              <div>
                ...
                <div className="flex flex-wrap gap-3 select-none">
                  {renderSkills(
                    ["CATIA V5", "Fusion 360", "SolidWorks", "AutoCAD"],
                    "bg-orange-900",
                    "text-white",
                    "bg-orange-900",
                    "text-white"
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3 select-none">
                  {renderSkills(
                    ["LabVIEW", "C / C++ Embedded", "Programare CNC", "Matlab / Simulink", "Data Acquisition"],
                    "bg-orange-900",
                    "text-white",
                    "bg-orange-900",
                    "text-white"
